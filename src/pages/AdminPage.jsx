    ...
    return (
      <div style={{padding:24,maxWidth:1000,margin:'0 auto'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'repeat(2,1fr)',gap:12}}>
          <button onClick={() => navigate('/appointments?org=' + selectedOrg.id)} style={{padding:16,borderRadius:10,border:'1px solid #e5e7eb',background:'white',cursor:'pointer',textAlign:'left',fontWeight:500}}>📅 Ver Agenda</button>
          <button onClick={() => navigate('/customers?org=' + selectedOrg.id)} style={{padding:16,borderRadius:10,border:'1px solid #e5e7eb',background:'white',cursor:'pointer',textAlign:'left',fontWeight:500}}>👥 Ver Clientes</button>
          <button onClick={() => navigate('/automations?org=' + selectedOrg.id)} style={{padding:16,borderRadius:10,border:'1px solid #e5e7eb',background:'white',cursor:'pointer',textAlign:'left',fontWeight:500}}>⚡ Ver Automatizaciones</button>
          <button onClick={() => navigate('/pets?org=' + selectedOrg.id)} style={{padding:16,borderRadius:10,border:'1px solid #e5e7eb',background:'white',cursor:'pointer',textAlign:'left',fontWeight:500}}>🐾 Ver Mascotas</button>
        </div>
      </div>
    )
  }
